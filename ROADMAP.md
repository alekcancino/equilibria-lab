...
| **R2 remediation — titration observables (R2-39)** | 🟡 Partial — absorbance and conductometry in Titulación ácido-base follow the shared `displayCurve` (aqueous, precipitating, biphasic, resin); complexometric/redox sub-modes and editable molar λ still open. |
