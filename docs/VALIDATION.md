...
| Activity | **High** | Extended D-H (fixed a or Kielland per-ion sizes), Davies (Spana's form, to I ≈ 0.5 M), and Güntelberg all available; engine-side corrections in other modules still apply extended D-H (a = 3 Å) |
